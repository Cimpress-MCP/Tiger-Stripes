// <copyright file="TypeParameterGenerator.cs" company="Cimpress plc">
...
""";
        ...
        {
            var operation = generatorSyntaxContext.SemanticModel.GetOperation(generatorSyntaxContext.Node, ct);
            return operation.IsValidOperation(out var invocationOperation)
                ? new InvocationMapping(invocationOperation, generatorSyntaxContext.SemanticModel)
                : null;
        }
    }
}
