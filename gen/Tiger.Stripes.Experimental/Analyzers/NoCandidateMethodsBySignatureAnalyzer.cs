// <copyright file="NoCandidateMethodsBySignatureAnalyzer.cs" company="Cimpress plc">
    ...
    : DiagnosticAnalyzer
{
    ...
    static void AnalyzeSyntaxNode(SyntaxNodeAnalysisContext context, INamedTypeSymbol containingType)
    {
        ...
        var methodDefinitions = from dsr in candidateMethod.DeclaringSyntaxReferences
