...
{
    static readonly AssemblyName s_assemblyName = typeof(StringBuilderExtensions).Assembly.GetName();

    /// <summary>Appends dependency arguments to this instance.</summary>
    /// <param name="builder">The instance to which to append dependency arguments.</param>
...
"""));
    ...
    /// <param name="builder">The instance to which to append the generated code attribute.</param>
    /// <returns>This instance.</returns>
    ...
    /// <param name="builder">The instance to which to append the handler documentation.</param>
    /// <returns>This instance.</returns>
    ...
    /// <param name="builder">The instance to which to append the serialization parameters' documentation.</param>
    ...
    /// <param name="builder">The instance to which to append trailing parameters.</param>
    /// <param name="overload">The value from which to determine which values to append.</param>
    /// <returns>This instance.</returns>
...
"""))
    ...
    /// <param name="builder">The instance to which to append type parameters.</param>
    /// <param name="overload">The value from which to determine which values to append.</param>
    /// <returns>This instance.</returns>
